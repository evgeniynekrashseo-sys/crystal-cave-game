...
function loadV32(){if(document.querySelector('script[data-chemlab-v32]'))return;const s=document.createElement('script');s.src='progression-v32.js?v=32';s.dataset.chemlabV32='1';document.body.appendChild(s);const h=document.querySelector('#settingsPanel h2');if(h)h.textContent='Лабораторія V32'}
function boot(){apply();const tools=document.querySelector('.tools');if(tools&&!document.getElementById('shop31')){const b=document.createElement('button');b.id='shop31';b.className='icon-btn';b.textContent='◈';b.title='Лабораторний магазин';b.onclick=open;tools.insertBefore(b,document.getElementById('settings'))}loadV32()}
