...
if(pkg.version!=='103.0.0') fail(`package version must be 103.0.0, got ${pkg.version}`); else pass(`release version ${pkg.version}`);
...
const sourceBundle=[main,certified,cosmeticOwnership,cosmeticLadder].join('\n');
