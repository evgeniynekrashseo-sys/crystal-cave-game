import {CITY_RESEARCH} from './city-research.js?v=21';
import {mountCityHud} from './city-hud.js?v=21';
import {drawSettlement,mapTile} from './settlement-renderer.js?v=21';
import {bindMapControls,boundCamera,projectPoint,MIN_ZOOM,MAX_ZOOM} from './settlement-camera.js?v=21';
import {SIZE,TYPES,TECH,LABELS,deliverDiscovery,terrain,normalizeCity,onChemistryWin,stats,step,build,canPlace,upgrade,upgradeCost,expand,research,affordable,demolish,demolitionRefund,VOYAGES,voyageError,dispatchVoyage,claimCityCoins,cityGoal,claimCityGoal,ensureCitySystems,cityEra,DISTRICTS,EXPEDITIONS,CITY_EVENTS,advanceCitySystems,resolveCityEvent,dispatchExpedition,expeditionError,districtSummary} from './settlement-model.js?v=21';
...
export function initCity(api){
 ...
 bind('city-event-resolve',()=>{if(resolveCityEvent(c)){persist();hud();panel();notice('Хімічне рішення спрацювало.')}});
