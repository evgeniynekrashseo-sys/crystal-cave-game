...
const settingsTitle=document.querySelector<HTMLElement>('#settingsPanel h2');if(settingsTitle)settingsTitle.textContent='ChemLab V99';
const settingsCopy=document.querySelector<HTMLElement>('#settingsPanel p');if(settingsCopy)settingsCopy.textContent='Approved full asset lock · physical reagent motion cues · first-session coach · reward anticipation loop · prestige cosmetic vault · cosmetic unlock previews · read-only economy readiness · premium victory payoff · certified anti-repeat puzzles · guaranteed solution paths';
function render(){
